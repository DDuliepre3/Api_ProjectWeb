        ...
        <div>
            <footer className="footer--bottom">
                <div className="footer--card">
                    ...
                    <p>I am Dominick Duliepre, a designer and a developer. This website was created for consumers to find their preferred gaming console at any time. The three different companies - Sony, Microsoft, Nintendo - offer various types of efficient gaming consoles for gamers worldwide. Found below are icons that link to the consoles' original websites (for more information).</p>
